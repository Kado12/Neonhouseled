...
<head>
    ...
    <meta name="description" content="Renueva tu espacio comercial con NHL Decoraciones y destaca con un diseño innovador y funcional"/>
...
<?php require_once "../layout/header.php" ?>
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/public/imagenes/decoracion/AnyConv.com__CEVICHERIA.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/decoracion/AnyConv.com__SANGUCHERIA.jpg.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/decoracion/AnyConv.com__RESTAURANTE JAPONES.jpg.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/decoracion/AnyConv.com__SALON SPA.jpg.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <p class="action-title">ATRÉVETE CON NHL A <br>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Diseño%20Comercial">CREA AQUÍ TU DISEÑO</a>
    </div>
</div>
