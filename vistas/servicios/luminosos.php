...
<head>
    ...
    <meta name="description" content="Ilumina tu negocio con estilo, nuestro equipo de diseñadores crearán letreros luminosos que destaquen tu marca y atraigan a los clientes."/>
...
<?php require_once "../layout/header.php" ?>
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/public/imagenes/luminosos/AnyConv.com__LETRERO LUMINOSO UNO.jpg.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/luminosos/AnyConv.com__LETRRERO LUMINOSO ODS.jpg.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/luminosos/AnyConv.com__LETRERO LUMINOSO TRES.jpg.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/luminosos/AnyConv.com__LETRERO LUMINOSO CUATRO.jpg.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <p class="action-title">ATRÉVETE CON NHL A <br>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Letreros%20Luminosos">CREA AQUÍ TU DISEÑO</a>
    </div>
</div>
