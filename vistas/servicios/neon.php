...
<head>
    ...
    <meta name="description" content="Diseños de letreros y rótulos en Led y neón. Nuestro servicio personalizado y de calidad ayudará a que tu negocio destaque  ¡Contáctanos para conocer nuestro catálogo!"/>
...
<?php require_once "../layout/header.php" ?>
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/public/imagenes/neon/AnyConv.com__F. NEON UNO.jpg.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/neon/AnyConv.com__F. NEON DOS.jpg.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/neon/AnyConv.com__F. NEON TRES.jpg.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/neon/AnyConv.com__F. NEON CUATRO.jpg.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <p class="action-title">ATRÉVETE CON NHL A <br>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Fabricación%20Neon">CREA AQUÍ TU DISEÑO</a>
    </div>
</div>
