...
<head>
    ...
    <meta name="description" content="Ilumina tu espacio con nuestro servicio de diseño y fabricación de panel led. ¡Contáctanos hoy y comienza la transformación de tu espacio con nuestros paneles LED!"/>
    ...
    <main class="main__categoria">
        ...
        <div class="logos">
          <div class="logos-slide">
            <img src="/public/imagenes/led/PL-1.jfif" />
            <img src="/public/imagenes/led/PL-2.jfif" />
            <img src="/public/imagenes/led/PL-3.jfif" />
            <img src="/public/imagenes/led/PL-4.jfif" />
          </div>
        </div>
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/public/imagenes/led/AnyConv.com__PANEL LED UNO.jpg.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/led/AnyConv.com__PANEL LED DOS.jpg.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/led/AnyConv.com__PANEL LED TRES.jpg.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/led/AnyConv.com__PANEL LED CUATRO.jpg.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <p class="action-title">ATRÉVETE CON NHL A <br>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Paneles%20Led">CREA AQUÍ TU DISEÑO</a>
    </div>
</div>
