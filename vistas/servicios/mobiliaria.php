...
<head>
    ...
    <meta name="description" content="Alquiler y venta de mobiliarios para eventos. Fabricamos mobiliarios con diseños personalizados a medida  y de calidad. ¡Contáctanos para conocer nuestro catálogo!"/>
...
<?php require_once "../layout/header.php" ?>
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/public/imagenes/moviliaria/AnyConv.com__MOBILIARIA UNO.jpg.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/moviliaria/AnyConv.com__MOBILIARIO DOS.jpeg.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/moviliaria/AnyConv.com__MOBILIARIO TRES.jpg.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="/public/imagenes/moviliaria/AnyConv.com__MOBILIARIO CUATRO.jpeg.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <p class="action-title">ATRÉVETE CON NHL A <br>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Fabricación%20Mobiliaria">CREA AQUÍ TU DISEÑO</a>
    </div>
</div>
