...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="text1">
        ...
        <h3 class="welcom__item__text"> SI ESTÁS BUSCANDO MEJORAR LA EXPERIENCIA DE TUS CLIENTES Y MAXIMIZAR SU RENDIMIENTO Y BIENESTAR, NUESTRO ENFOQUE ES TU MEJOR OPCIÓN</h3>
        <h3 class="welcom__item__contacto">¡¡NO ESPERES MÁS Y CONTÁCTANOS PARA TRANSFORMAR TU GIMNASIO EN UN LUGAR INSPIRADOR Y MOTIVADOR!!</h3>
    </div>
    <div class="curvas">
