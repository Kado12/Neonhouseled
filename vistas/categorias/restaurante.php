...
<head>
    ...
    <meta name="description" content="¿Quieres que tu restaurante tenga éxito? Transforma el diseño y la decoración interior de tu negocio. ¡Contáctanos ahora para asesorarte con diseños novedosos y personalizados!"/>
    <!-- Google tag (gtag.js) -->
...
<?php require_once "../layout/header.php" ?>
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/RESTAURANTE/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/RESTAURANTE/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/RESTAURANTE/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">SI TU RESTAURANTE NO LOGRA CREAR VÍNCULOS SÓLIDOS CON TUS CLIENTES POTENCIALES</h2>
        <h3 class="welcom__item__text">EN NUESTRO EQUIPO, NOS ESPECIALIZAMOS EN DISEÑAR RESTAURANTES QUE VAN DESDE LA SIMPLICIDAD HASTA EL LUJO. CON NUESTRA EXPERIENCIA, PODEMOS TRANSFORMAR TU ESPACIO EN UN LUGAR QUE CAUTIVARÁ A TUS CLIENTES</h3>
    ...
    <p class="action-title">¡HAZ DE TU RESTAURANTE UN ÉXITO!</p>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Restaurante">TRANSFORMA TU RESTAURANTE</a>
    </div>
</div>
