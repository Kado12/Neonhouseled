...
<?php require_once "../layout/header.php" ?>
    ...
    <div class="text1">
        ...
        <h3 class="welcom__item__text">SI SIENTES QUE TU DEPARTAMENTO CARECE DE CALIDEZ Y FUNCIONALIDAD, PERMÍTENOS RENOVARLO Y CREAR UN LUGAR QUE REALMENTE TE REPRESENTE, DONDE CADA RINCÓN CUENTA UNA HISTORIA Y CADA DETALLE ESTÁ CUIDADOSAMENTE DISEÑADO PARA ADAPTARSE A TU VID</h3>
